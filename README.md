# Лабораторна робота №4 -- Інтеграція фронтенду з бекендом (Варіант 7)

**Event Registration Service** -- REST API для реєстрації користувачів на події з TypeScript-фронтендом.
